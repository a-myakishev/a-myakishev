...
С 2018 года работаю в digital, с 2023 — в веб-аналитике и аналитике данных. <br><br>

Мои основные направления работы:
1. Настройка сбора и передачи данных для аналитики 
2. Разрабатка дашбордов
3. Автоматизация отчетности
4. Ad-hoc-анализ и консультация коллег и клиентов
   
Кроме классической DA, интересуюсь направлением продуктовой аналитики: A/B-тестами, сегментацией пользователей и исследованием UX. 
